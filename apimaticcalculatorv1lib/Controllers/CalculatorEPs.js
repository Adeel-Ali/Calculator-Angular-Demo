...
angular.module('APIMATICCalculatorV1Lib')
    .factory('CalculatorEPs', ['$q', 'Configuration', 'HttpClient', 'APIHelper', 'BaseController', CalculatorEPs
    ]);

    function CalculatorEPs($q, Configuration, HttpClient, APIHelper, BaseController) {
        return {
            /**
